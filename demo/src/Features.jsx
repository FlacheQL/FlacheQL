    ...
    return (
      <div className="modal" >
        ...
        <div className="description"> 
          ...
          it is understood that a greater number of stars on a Repository will ultimately yeild less search results, and that a smaller number of repositories being searched will also yeild fewer results. Thus, both parameters are specified as qualifications for subset retrievals.
