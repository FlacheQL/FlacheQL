...
const Home = () => (
  <div className="landing-container">
    <div id="landing-content">
      ...
      <p>FlacheQL is a <font className="standout">developer-friendly</font> client-side caching library for GraphQL built with one thing in mind — <font className="standout">speed</font>. Written in pure javascript by a small team, FlacheQL provides developers with a fast and easy way to cache GraphQL queries without sacrificing the core functionality of larger frameworks like Apollo and Relay. Additionally, FlacheQL offers partial caching on GraphQL search parameters, a feature that is currently not available in <font className="standout">any other open-source caching engine</font>.</p>
      <p>Below you will find two <font className="standout">demonstrations</font> of our engine's performance on 2 different APIs. If you're new to GraphQL caching, try sending queries to Yelp's API to see a simple implementation of FlacheQL. If you want to see how we stack up against the leading GraphQL caching engine, Apollo Client's inMemoryCache, give the Github demo a shot.</p>
